...
namespace El_Camello.Modelo.dao
{
    public class ConversacionesDAO
    {
        ...
        public static void GetConversacionesDemandante(int idAspirante, string token)
        {

        }
        public static void GetConversacionDemandante(int idConversacion, int idAspirante, string token)
        {

        }
        public static void PostMensajeDemandante(int idConversacion, int idAspirante, string mensaje, string token)
        {
