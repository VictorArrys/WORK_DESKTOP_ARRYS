...
DROP TABLE IF EXISTS `valoraciones_aspirantes`;
/*!50001 DROP VIEW IF EXISTS `valoraciones_aspirantes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `valoraciones_aspirantes` AS SELECT 
 1 AS `aspirante`,
 1 AS `id_aspirante`,
 1 AS `valoracion_aspirante`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `valoraciones_empleadores`
--

DROP TABLE IF EXISTS `valoraciones_empleadores`;
/*!50001 DROP VIEW IF EXISTS `valoraciones_empleadores`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `valoraciones_empleadores` AS SELECT 
 1 AS `empleador`,
 1 AS `id_empleador`,
 1 AS `valoracion_empleador`*/;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2022-06-01 13:42:48
